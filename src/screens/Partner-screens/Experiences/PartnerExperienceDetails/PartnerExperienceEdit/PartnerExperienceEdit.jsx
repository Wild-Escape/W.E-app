...
function PartnerExperienceEdit() {
  const { id } = useParams();
  ...
  const handleSubmit = (e) => {
    ...
    console.log("check data befor server call", formData)
    updateExperienceService(id, uploadData)
      .then(() => {
        navigate(`/partner/experience/${id}/details`);
      })
      .catch((error) => {
...
export default PartnerExperienceEdit;
